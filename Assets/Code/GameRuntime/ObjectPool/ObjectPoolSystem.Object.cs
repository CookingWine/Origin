...
namespace RuntimeLogic.ObjectPool
{
    internal sealed partial class ObjectPoolSystem:ISystemCore, IUpdateSystem, IObjectPoolManager
    {
        /// <summary>
        /// 对象池。
        /// </summary>
        ...
        private sealed class ObjectPool<T>:ObjectPoolBase, IObjectPool<T> where T : ObjectBase
        {
            ...
            public bool CanSpawn(string name)
            {
                ...
                if(m_Objects.TryGetValue(name , out GameFrameworkLinkedListRange<Object<T>> objectRange))
                {
