...
namespace RenderHeads.Media.AVProVideo.Editor
{
	...
	public static class EditorHelper
	{
		...
		internal static bool HasScriptDefine(string define, BuildTargetGroup buildTarget = BuildTargetGroup.Unknown)
		{
            ...
            NamedBuildTarget tempTarget = NamedBuildTarget.FromBuildTargetGroup(buildTarget);

            string defines = PlayerSettings.GetScriptingDefineSymbols(tempTarget);
		...
		internal static void AddScriptDefine(string define, BuildTargetGroup buildTarget = BuildTargetGroup.Unknown)
		{
			...
			{
				defines += ";" + define + ";";
				PlayerSettings.SetScriptingDefineSymbols(tempTarget , defines);
			}
		}
